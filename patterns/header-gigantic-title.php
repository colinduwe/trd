<?php
/**
 * Title: Header with a gigantic site title, menu, and social icons.
 * Slug: trd/header-gigantic-title
...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-group alignwide">
		...
		<!-- wp:site-title {"style":{"spacing":{"margin":{"top":"1em","bottom":"0em"}}},"fontSize":"gigantic"} /-->
	</div>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->