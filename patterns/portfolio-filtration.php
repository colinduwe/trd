...
<div class="wp-block-group alignwide" style="padding-bottom:0.5em">
	...
	<div class="wp-block-buttons">
		<!-- wp:button {"className":"is-style-trd-arrow","fontSize":"large"} -->
		<div class="wp-block-button has-custom-font-size is-style-trd-arrow has-large-font-size"><a
