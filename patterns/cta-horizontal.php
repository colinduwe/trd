...
<div class="wp-block-group alignwide has-senary-background-color has-background">
	...
	<div class="wp-block-columns is-style-default">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<h2 class="has-text-align-left">Work With Us!</h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-buttons is-content-justification-right">
				...
				<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-primary-background-color has-background">Send us an email</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
