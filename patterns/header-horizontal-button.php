 ...
 * Slug: trd/header-horizontal-button
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-buttons">
				<!-- wp:button {"backgroundColor":"accent","textColor":"foreground"} -->
				<div class="wp-block-button"><a
						class="wp-block-button__link has-foreground-color has-accent-background-color has-text-color has-background">Say
						Hi</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
