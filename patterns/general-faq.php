...
<div class="wp-block-group"><!-- wp:separator {"backgroundColor":"gray","className":"is-style-wide"} -->
...
<p>Can't find your question? <a href="">Contact us!</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="padding-top:32px"><!-- wp:separator {"backgroundColor":"gray","className":"is-style-wide"} -->
<hr class="wp-block-separator has-text-color has-gray-color has-alpha-channel-opacity has-gray-background-color has-background is-style-wide"/>
<!-- /wp:separator -->

<!-- wp:columns {"style":{"spacing":{"padding":{"top":"32px","bottom":"32px"}}}} -->
<div class="wp-block-columns" style="padding-top:32px;padding-bottom:32px"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":5,"fontSize":"heading-6"} -->
<h5 class="wp-block-heading has-heading-6-font-size">Lorem ipsum dolor sit amet?</h5>
<!-- /wp:heading --></div>
<!-- /wp:column -->
