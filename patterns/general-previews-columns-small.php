 ...
 * Slug: trd/general-previews-columns-small
 * Categories: trd-general
 */
?>
<!-- wp:group {"align":"wide"} -->
<div class="wp-block-group alignwide">
	...
	<div class="wp-block-group">
		...
		<hr
			class="wp-block-separator has-text-color has-accent-color has-alpha-channel-opacity has-accent-background-color has-background is-style-wide" />
		<!-- /wp:separator -->
	...
	<!-- wp:query {"queryId":27,"query":{"perPage":"3","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"flex","columns":3},"align":"wide"} -->
	<div class="wp-block-query alignwide">
		<!-- wp:post-template -->
		<!-- wp:group {"align":"wide","style":{"border":{"radius":"16px"},"spacing":{"margin":{"top":"0px","bottom":"0px"}}}} -->
		<div class="wp-block-group alignwide" style="border-radius:16px;margin-top:0px;margin-bottom:0px">
